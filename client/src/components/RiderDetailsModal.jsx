...
const RiderDetailsModal = ({ rider, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#10173A] bg-opacity-70 flex justify-center items-center z-50 p-4">
      <div className="bg-[#10173A] text-white rounded-2xl shadow-2xl p-6 max-w-6xl w-full">
        <div className="flex justify-between items-start mb-4">
          <h2 className="text-2xl font-bold text-white">Rider Details</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className={`flex items-center space-x-2 mt-1 ${rider.online ? 'text-green-400' : 'text-red-400'}`}>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold border-b border-blue-800 pb-2">Vehicle</h4>
            ...
            <h4 className="text-lg font-semibold border-b border-blue-800 pb-2 mt-6">Bank Details</h4>
            <DetailItem
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold border-b border-blue-800 pb-2">Performance</h4>
            <div className="flex items-center space-x-2">
              <StarIcon className="h-5 w-5 text-yellow-400" />
              <span>{rider.averageRating?.toFixed(1) || 'N/A'}</span>
              <span className="text-sm text-gray-400">({rider.totalRatings} ratings)</span>
            </div>
            <div className="flex items-center space-x-2">
              <XCircleIcon className="h-5 w-5 text-red-500" />
              <span>{rider.strikes} strikes</span>
            </div>
            <DetailItem
            ...
            <h4 className="text-lg font-semibold border-b border-blue-800 pb-2 mt-6">Account Status</h4>
            <DetailItem
              icon={ShieldCheckIcon}
              label="Verified"
