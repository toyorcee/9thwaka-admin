      ...
      <>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500">
            <p className="text-sm text-gray-500 font-medium">Eligible Lead Users</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
            <p className="text-sm text-gray-500 font-medium">Users Rewarded</p>
            <div className="flex justify-between items-end">
              <p className="text-2xl font-bold text-gray-800">
          ...
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-yellow-500">
            <p className="text-sm text-gray-500 font-medium">Bonus Value</p>
            <div className="flex justify-between items-end">
              <p className="text-2xl font-bold text-gray-800">
                ₦{(stats.config?.discountAmount ?? 0).toLocaleString()}
              </p>
        ...
        {stats.config && (
            <div className="bg-teal-50 border border-teal-100 rounded-lg p-4 mb-6">
                <div className="flex items-center mb-3">
                    ...
                    <h3 className="font-bold text-teal-900">New Joiner (First Order) Rules</h3>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white/50 p-2 rounded border border-teal-50">
                        <span className="block text-[10px] text-teal-400 uppercase font-black tracking-widest">Trip Requirement</span>
                        <span className="text-sm font-bold text-teal-700">{stats.config.limitCount || 1} Trip</span>
                    </div>
                    <div className="bg-white/50 p-2 rounded border border-teal-50">
                        <span className="block text-[10px] text-teal-400 uppercase font-black tracking-widest">Min Order Value</span>
                        <span className="text-sm font-bold text-teal-700">₦{(stats.config.minTripValue || 0).toLocaleString()}</span>
                    </div>
                    <div className="bg-white/50 p-2 rounded border border-teal-50">
                        <span className="block text-[10px] text-teal-400 uppercase font-black tracking-widest">Reward Expiry</span>
                        <span className="text-sm font-bold text-teal-700">{stats.config.rewardExpiryDays || 14} Days</span>
                    </div>
                    <div className="bg-white/50 p-2 rounded border border-teal-50">
                        <span className="block text-[10px] text-teal-400 uppercase font-black tracking-widest">Status</span>
                        <span className={`text-sm font-bold ${stats.config.enabled ? 'text-green-600' : 'text-red-500'}`}>
                            {stats.config.enabled ? 'ACTIVE' : 'INACTIVE'}
                        </span>
                    </div>
                </div>
            </div>
