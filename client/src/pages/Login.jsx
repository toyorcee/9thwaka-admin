...
const Login = () => {
  ...
  return (
    ...
    >
      {/* Dark Overlay for better text contrast - unified with ForgotPassword */}
        ...
        <div className="bg-white/95 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-4">
              <button
                className="w-full bg-[#000029] hover:bg-[#2b72e1] text-white font-semibold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#157AFF] focus:ring-offset-2 focus:ring-offset-white transition duration-300 shadow-md disabled:opacity-70 disabled:hover:scale-100"
                type="submit"
                disabled={loading}
              >
                {loading ? (
