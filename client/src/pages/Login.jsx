        ...
        <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-4">
              <button
                className="w-full bg-[#000029] hover:bg-[#2b72e1] text-white font-semibold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#157AFF] focus:ring-offset-2 focus:ring-offset-white transition duration-300 transform hover:scale-105 shadow-md"
                type="submit"
              >
                Sign In
              </button>
